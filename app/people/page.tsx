...
export default async function People(){
 ...
 return <main className="project-page people-page">
  ...
  <section className="people-directory"><div className="section-heading"><div><p className="eyebrow">DIRECTORY</p><h2>Project members</h2></div><span>{p.rowCount} projects</span></div>
   {members.rowCount?<div className="members-table-wrap"><table className="members-table"><thead><tr><th>Member</th><th>Role</th><th>Contact</th><th>Assigned projects</th><th>Access & notifications</th></tr></thead><tbody>{members.rows.map(x=><tr key={`${x.id}-${x.role}-${x.title}`}>
